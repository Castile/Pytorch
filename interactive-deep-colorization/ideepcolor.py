...
def parse_args():
    ...
    parser.add_argument('--image_file', dest='image_file', help='input image', type=str, default='F:\\jetbrains\pycharm\\interactive-deep-colorization\\test_imgs\\mortar_pestle.jpg')
    ...
    parser.add_argument('--color_model', dest='color_model', help='colorization model', type=str,
                        default='./models/pytorch/pytorch.pth')
...
if __name__ == '__main__':
    ...
    window = gui_design.GUIDesign(color_model=colorModel, dist_model=distModel,
                                  img_file='F:\\jetbrains\pycharm\\interactive-deep-colorization\\test_imgs\\mortar_pestle.jpg', load_size=args.load_size, win_size=args.win_size)
